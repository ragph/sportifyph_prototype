  ...
  const plans = [
    {
      ...
      savings: null,
      features: [
        'Create up to 10 campaigns',
        'Reach 1,000+ athletes',
        'Basic analytics',
        'Athlete database access',
        'Campaign management',
        'Email support',
        'Cancel anytime'
      ],
  ...
  const benefits = [
    {
      ...
      description: 'Create and manage sponsorship campaigns easily'
    },
    {
      icon: IoFlash,
      title: 'Real-time Analytics',
      description: 'Track campaign performance and ROI instantly'
    },
    {
      icon: IoPeople,
      title: 'Athlete Network',
      description: 'Access thousands of athletes and teams'
    },
    {
      icon: IoStar,
      title: 'Premium Features',
      description: 'Advanced targeting and reporting tools'
    }
  ]

  const handleSubscribe = (planId) => {
    navigate(`/sponsor/subscribe-payment/${planId}`)
  }

  return (
    <div className="min-h-screen bg-dark-bg pb-6">
      <PageHeader title="Subscription Plans" backPath="/sponsor/dashboard" />
            ...
            .map((plan) => (
              <div
                ...
                className={`bg-dark-bg-tertiary rounded-xl p-6 shadow-lg ${
                  plan.popular ? 'border-2 border-indigo-600' : 'border border-dark-border'
                }`}
              >
                {plan.popular && (
                  <div className="bg-indigo-600 text-white text-xs font-bold px-3 py-1 rounded-full inline-block mb-4">
                    MOST POPULAR
                  </div>
                )}
        ...
        <div className="bg-dark-bg-tertiary rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-dark-text-secondary">You'll need to subscribe to continue accessing premium features. Your campaigns and data will be preserved.</p>
            </div>
            <div>
...
export default SponsorSubscription
