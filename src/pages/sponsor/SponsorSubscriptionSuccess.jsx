...
import { IoCheckmarkCircle, IoBriefcase, IoFlash, IoPeople, IoStar } from 'react-icons/io5'

const SponsorSubscriptionSuccess = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Access thousands of athletes'
    },
    {
      icon: IoStar,
      title: 'Premium Tools',
      description: 'Advanced targeting and reporting'
    }
  ]
          ...
          <div className="bg-indigo-50 rounded-xl p-6 mb-6">
            <div className="text-sm text-dark-text space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">partnerships@nike.com.ph</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-3">
...
export default SponsorSubscriptionSuccess
