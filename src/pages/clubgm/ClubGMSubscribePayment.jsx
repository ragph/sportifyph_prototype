...
const ClubGMSubscribePayment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      navigate('/clubgm/subscription-success')
    }, 2000)
  }
  ...
  return (
    <div className="min-h-screen bg-dark-bg pb-20">
      <PageHeader title="Subscribe" backPath="/clubgm/subscription" />
      ...
      <div className="max-w-lg mx-auto p-4">
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`p-4 border-2 rounded-lg font-medium text-sm transition-all ${
                  formData.paymentMethod === 'gcash'
                    ? 'border-orange-600 bg-brand-primary/10 text-brand-primary'
            ...
            <div className="mt-4 p-4 bg-brand-primary/10 rounded-lg">
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="mt-1 w-4 h-4 text-brand-primary border-dark-border rounded focus:ring-orange-500"
                />
                <div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-semibold text-lg transition-colors flex items-center justify-center shadow-lg ${
...
export default ClubGMSubscribePayment
