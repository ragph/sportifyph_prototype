...
const PlayerSubscribePayment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      navigate('/player/subscription-success')
    }, 2000)
  }
    ...
    <div className="min-h-screen bg-dark-bg pb-20">
      ...
      <div className="max-w-lg mx-auto p-4">
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`p-4 border-2 rounded-lg font-medium text-sm transition-all ${
                  formData.paymentMethod === 'gcash'
                    ? 'border-blue-600 bg-brand-accent/10 text-brand-accent'
            ...
            <div className="space-y-3">
              ...
              <div className="border-t border-dark-border pt-3 mt-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-brand-accent">₱{selectedPlan.price}</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 p-4 bg-brand-accent/10 rounded-lg">
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="mt-1 w-4 h-4 text-brand-accent border-dark-border rounded focus:ring-brand-primary"
                />
                <div>
          ...
          {/* Security Badge */}
          <div className="bg-brand-accent/10 border border-green-200 rounded-xl p-4 flex items-center space-x-3">
            <IoShield className="text-2xl text-brand-accent flex-shrink-0" />
            <div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-yellow-700">
                Not satisfied? Get a full refund within 7 days of your subscription start date. No questions asked.
              </p>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full py-4 bg-brand-accent hover:bg-brand-accent-dark text-white rounded-xl font-semibold text-lg transition-colors flex items-center justify-center shadow-lg ${
...
export default PlayerSubscribePayment
