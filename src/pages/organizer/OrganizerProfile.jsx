...
const OrganizerProfile = () => {
  ...
  const profile = {
    name: 'Metro Sports Events',
    username: '@metrosports',
    bio: 'Premier pickleball event organizer in Metro Manila. We specialize in organizing professional and recreational pickleball tournaments for all skill levels. Creating memorable pickleball experiences since 2020.',
    rating: 4.7,
    reviewCount: 85,
  ...
  const stats = [
    { icon: IoTrophy, value: '42', label: 'Tournaments Hosted', color: 'purple' },
    { icon: IoPeople, value: '2,450', label: 'Total Participants', color: 'purple' },
    { icon: IoCash, value: '₱890K', label: 'Total Revenue', color: 'purple' },
    { icon: IoStar, value: '4.7', label: 'Rating', color: 'purple' }
  ]

  const eventTypes = [
    { name: 'Singles Pickleball', count: '18' },
    { name: 'Doubles Pickleball', count: '12' },
    { name: 'Mixed Doubles', count: '8' },
    { name: 'Corporate Tournaments', count: '4' }
  ]
  ...
  const achievements = [
    ...
    '5-Star Rated Organizer'
  ]

  const contactInfo = [
    { icon: IoMail, label: 'Email', value: 'info@metrosports.com' },
    { icon: IoCall, label: 'Phone', value: '+63 912 345 6789' },
    { icon: IoGlobe, label: 'Website', value: 'www.metrosports.com' },
    { icon: IoLocationSharp, label: 'Location', value: 'Quezon City, Metro Manila' }
  ]
  ...
  return (
    <div className="min-h-screen bg-dark-bg pb-20">
      <div className="max-w-lg mx-auto p-4 space-y-6">
        ...
        <div className="bg-dark-bg-tertiary rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="relative px-4 pb-4">
            ...
            <div className="flex space-x-3 mb-4">
              <button
                onClick={() => navigate('/organizer/edit-profile')}
                className="flex-1 bg-purple-600 hover:bg-purple-700 text-white rounded-lg py-3 px-4 font-semibold transition-colors flex items-center justify-center space-x-2"
              >
                <IoCreate />
        ...
        {/* Event Types */}
        <div className="bg-dark-bg-tertiary rounded-xl p-4 shadow-sm">
          <h2 className="text-lg font-bold text-dark-text mb-4">Event Types</h2>
          <div className="space-y-3">
            {eventTypes.map((type, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-dark-bg rounded-lg">
                <div className="flex items-center space-x-3">
                  <IoTrophy className="text-xl text-brand-primary" />
