...
const OrganizerSubscription = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Easily host and manage tournaments of any size'
    },
    {
      icon: IoFlash,
      title: 'Real-time Updates',
      description: 'Get instant notifications for registrations and payments'
    },
    {
      icon: IoPeople,
      title: 'Participant Analytics',
      description: 'Track participant data and event performance'
    },
    {
      icon: IoStar,
  ...
  const handleSubscribe = (planId) => {
    navigate(`/organizer/subscribe-payment/${planId}`)
  }

  return (
    <div className="min-h-screen bg-dark-bg pb-20">
      <PageHeader title="Subscription Plans" backPath="/organizer/dashboard" />
            ...
            .map((plan) => (
              <div
                ...
                className={`bg-dark-bg-tertiary rounded-xl p-6 shadow-lg ${
                  plan.popular ? 'border-2 border-purple-600' : 'border border-dark-border'
                }`}
              >
                {plan.popular && (
        ...
        <div className="bg-dark-bg-tertiary rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-dark-text-secondary">You'll need to subscribe to continue accessing premium features. Your tournaments and data will be preserved.</p>
            </div>
            <div>
